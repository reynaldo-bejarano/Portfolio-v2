...
const Hero = () => {
    return (
        <section className='flex justify-center items-center py-10 2xl:py-44'>
            <div>
                <div>
                    <h3 className='text-center p-5 text-3xl 2xl:text-6xl font-bold text-slate-700'>Hello & Welcome</h3>
                    <h1 className='text-center p-5 text-6xl  2xl:text-8xl font-bold text-slate-700'>I'm Reynaldo Bejarano</h1>
